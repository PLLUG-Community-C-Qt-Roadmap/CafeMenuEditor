    ...
    mRoot{nullptr}
{
    ...
    connect(ui->actionView_example_menu,SIGNAL(triggered(bool)),
            this,SLOT(slotDeleteMenuItem()),Qt::UniqueConnection);
    connect(ui->actionView_example_menu,SIGNAL(triggered(bool)),
            this,SLOT(slotPrintMenu()));
...
void MainWindow::slotDeleteMenuItem()
{
    delete mRoot;
}
